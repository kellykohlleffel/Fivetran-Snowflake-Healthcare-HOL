...
-- Database: HOL_DATABASE_2.HEALTHCARE_SEMANTIC
-- Semantic View: HOL_DATABASE_2.HEALTHCARE_SEMANTIC.SV_CLINICAL_DECISIONS

CREATE OR REPLACE AGENT HOL_DATABASE_2.HEALTHCARE_SEMANTIC.CLINICAL_DECISIONS_AGENT
...
tool_resources:
  query_clinical_data:
    execution_environment:
      ...
      type: warehouse
      warehouse: ""
    semantic_view: "HOL_DATABASE_2.HEALTHCARE_SEMANTIC.SV_CLINICAL_DECISIONS"
$$;
