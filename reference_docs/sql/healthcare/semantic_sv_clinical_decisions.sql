create or replace semantic view HOL_DATABASE_2.healthcare_semantic.sv_clinical_decisions
  

TABLES (
  CLINICAL_DECISIONS AS HOL_DATABASE_2.healthcare_marts.fct_clinical_decisions
    UNIQUE (RECORD_ID)
